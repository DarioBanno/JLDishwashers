...
class ProductTests: XCTestCase {
    ...
    func test_product_is_created_from_JSON_ProductList_fetch_by_productId() {
        ...
        XCTAssertEqual(product?.features?.count, 0)
        XCTAssertEqual(product?.features?[0].attributes?.count, 3)
        XCTAssertEqual(product?.features?[0].attributes?[0].name, "Dimensions")
        XCTAssertEqual(product?.features?[0].attributes?[0].value, "H30 x W30 x D30cm")
        XCTAssertEqual(product?.features?[0].attributes?[1].name, "Quick wash")
        XCTAssertEqual(product?.features?[0].attributes?[1].value, "Yes")
        XCTAssertEqual(product?.features?[0].attributes?[2].name, "Drying performance")
        XCTAssertEqual(product?.features?[0].attributes?[2].value, "A")
    }
