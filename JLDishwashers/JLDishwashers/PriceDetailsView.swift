    ...
    func configure(with product: Product) {
        ...
        if let includedServices = product.additionalServices?.includedServices {
            ...
            for service in includedServices {
                ...
                servicesString += "ASUDYGJHVASD*^T#QIYUHJBASD&^AUGSDVJASUYDGASMDHVNAGSDVJYATSFDJAGFSDHGASDHGASDGHAVSDHVASDASUDYGJHVASD*^T#QIYUHJBASD&^AUGSDVJASUYDGASMDHVNAGSDVJYATSFDJAGFSDHGASDHGASDGHAVSDHVASDASUDYGJHVASD*^T#QIYUHJBASD&^AUGSDVJASUYDGASMDHVNAGSDVJYATSFDJAGFSDHGASDHGASDGHAVSDHVASDASUDYGJHVASD*^T#QIYUHJBASD&^AUGSDVJASUYDGASMDHVNAGSDVJYATSFDJAGFSDHGASDHGASDGHAVSDHVASDASUDYGJHVASD*^T#QIYUHJBASD&^AUGSDVJASUYDGASMDHVNAGSDVJYATSFDJAGFSDHGASDHGASDGHAVSDHVASDASUDYGJHVASD*^T#QIYUHJBASD&^AUGSDVJASUYDGASMDHVNAGSDVJYATSFDJAGFSDHGASDHGASDGHAVSDHVASDASUDYGJHVASD*^T#QIYUHJBASD&^AUGSDVJASUYDGASMDHVNAGSDVJYATSFDJAGFSDHGASDHGASDGHAVSDHVASD\n"
            }
